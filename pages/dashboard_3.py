...
layout = html.Div([
    html.H1('Map Dashboard', style={'text-align': 'center', 'color': 'white', 'fontSize': '20px'}),
    ...
    ], style={'position': 'relative', 'border-radius': '20px', 'width': '100%', 'text-align': 'center', 'background-color': '#1A1A1A', 'margin': 'auto', 'padding-top': '80px'}),  # Adjusted width and centering# Relative positioning container for map and date picker
    ...
    ], style={'background-color': '#1A1A1A', 'padding': '10px', 'border-radius': '40px', 'margin-top': '20px', 'width': '80%', 'margin': 'auto'})

], style={'maxWidth': '1800px', 'margin': 'auto', 'border-radius': '20px', 'background-color': '#1A1A1A', 'color': 'white'})
